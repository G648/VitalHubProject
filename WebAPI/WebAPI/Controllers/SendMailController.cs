...
namespace WebAPI.Controllers
{
    ...
    public class SendMailController : ControllerBase
    {
        ...
        public async Task<IActionResult> SendMail(string email, string userName)
        {
            try
            {
                //cria um objeto para receber os dados do email a ser enviado
                MailRequest mailRequest = new MailRequest();
                //define o endereço, assunto e corpo do email
                mailRequest.ToEmail = email;
                mailRequest.Subject = "Olá, esse é o email vindo da turma de DEV3DM";
            ...
            {
                return BadRequest("Email falhou!!!");
            }
        }
